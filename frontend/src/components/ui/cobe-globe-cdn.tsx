...
export function GlobeCdn({
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      globe = createGlobe(canvas, {
        ...
        arcWidth: 1.5, arcHeight: 0.4, opacity: 0.8,
      })
      function animate() {
  ...
  const pyramidFaceStyle = (nth: number): React.CSSProperties => {
    ...
    const colors = ["#ef4444", "#dc2626", "#b91c1c", "#fca5a5"]
    return {
    ...
    <div className={`relative aspect-square select-none ${className}`}>
      ...
      {markers.map((m) => (
        ...
        >
          ...
          <span style={{
            fontFamily: "monospace", fontSize: "0.55rem", color: "#10b981",
            background: "#022c22", border: "1px solid #10b981", padding: "2px 6px", borderRadius: 3,
